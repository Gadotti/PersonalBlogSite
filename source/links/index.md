...
* [HxD](https://mh-nexus.de/en/hxd/) | Visualizador hexdecimal de arquivos)
* [stegseek](https://github.com/RickdeJager/stegseek) | Procura por palavras dentro de uma arquivo de imagem baseado em uma lista (rockyou, por exemplo)
* [binwalk](https://www.kali.org/tools/binwalk/) | Usado principalmente para extrair outros arquivos escondidos dentro de outros arquivos
* [steghide](https://medium.com/the-kickstarter/steganography-on-kali-using-steghide-7dfd3293f3fa) | Inserir ou extrair outros arquivos inseridos e protegidos com senha em outros arquivos
